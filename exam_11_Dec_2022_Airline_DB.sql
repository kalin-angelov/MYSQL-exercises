...
select 
concat(upper(substring(last_name,1, 2)), p.country_id) as flight_code,
...
select c.name, c.currency, count(destination_country) as booked_tickets
from flights as f
...
begin
	update flights
    set has_delay = true, departure = addtime(departure, '00:30:00')
